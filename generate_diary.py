...
def main():
    ...
    prompt = "Write a one‑sentence interesting fact or productivity tip for software developers. Keep it fun, original, and under 20 words."
    ...
    try:
        ...
        print(f"API error: {e}")
        tip = "AI was sleepy today – stay curious and keep coding!"
